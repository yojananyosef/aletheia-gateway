<script lang="ts">
  ...
  interface Props {
    view: 'home' | 'reader' | 'concordance' | 'devotionals' | 'strong';
    isCollapsed: boolean;
    menuOpen: boolean;
    isCalmMode: boolean;
...
<header class="app-topbar sticky top-0 z-30">
  ...
  <span class="topbar-title">
    {view === 'home' ? 'Inicio' : view === 'concordance' ? 'Concordancia' : view === 'devotionals' ? 'Devocional Diario' : view === 'strong' ? 'Diccionario Strong' : 'Lectura bíblica'}
  </span>
